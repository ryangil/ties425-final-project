...
public class GpsTracker extends Service implements LocationListener {
    ...
    public void notifyWhenReady(final LocationWait locationWait, final GpsTracker tracker)
    {
    	...
    	Runnable task = new Runnable(){
			public void run() {
				...
				locationWait.notifyLocationAvailable(location);
			}};
	...
	public void onLocationChanged(Location location) {
		...
		for(LocationSubscriber sub : subs)
		{
			sub.onLocationChanged(location);
		}
	}
